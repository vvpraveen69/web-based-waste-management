...
<html lang="en">
 ...
 <head>
    ...
    <title>Redivivus</title>
  </head>

<body>
    <!-- homepage -->
    <section id="one">
      <!-- left part (animation) of homepage -->
      <div class="left">
        <div class="head-wrapper">
          <h1 class="heading">
            <span class="intro intro-1" style="color: #013F59;">3+1<span style="color: #CC1E4A;">R</span></span>
            <span class="intro intro-2" style="color: #013F59;">for a</span>
            <span class="intro intro-3" style="color: #013F59;">Better Future.</span>
          </h1>
        </div>
        <!-- left part (buttons) of homepage -->
        <div class="left-bottom">
          <div class="login-text" id="user"></div>
          <div id="loginbtn">
            <a href="admin/login.php">
              <button class="login" type="button">Admin-login</button>
            </a>
          </div>
      ...
      <!-- right part (svg) of homepage -->
      <div class="right">
        <img src="images\home-graphic.svg" alt="home image">
      </div>
    </section>
          ...
          <div class="card-bottom">
            ...
            <div class="dev-title">
              <span>(Web Developer)<span></div>
                ...
                <div class="dev-btn">
                  <button type="submit" onclick="location.href='mailto:test@gmail.com';" target="blank">Connect</button>
                </div>
              </div>
              <div class="imgbox">
              ...
              <div class="card-bottom">
                ...
                <div class="dev-title">
                  <span>(Web Developer)<span></div>
                    ...
                    <div class="dev-btn">
                      <button type="submit" onclick="location.href='mailto:test1@gmail.com';" target="blank">Connect</button>
                    </div>
                  </div>
                  <div class="imgbox">
                  ...
                  <div class="card-bottom">
                    ...
                    <div class="dev-title">
                      <span>(Web Developer)<span></div>
                        ...
                        <div class="dev-btn">
                          <button type="submit" onclick="location.href='mailto:test3@gmail.com';" target="blank">Connect</button>
                        </div>
                      </div>
                      <div class="imgbox">
                      ...
                      <div class="card-bottom">
                        ...
                        <div class="dev-title">
                          <span>(Web Developer)<span></div>
                            ...
                            <div class="dev-btn">
                              <button type="submit" onclick="location.href='mailto:test4@gmail.com';" target="blank">Connect</button>
                            </div>
                          </div>
                          <div class="imgbox">
                              ...
                              <div class="card-bottom">
                                ...
                                <div class="dev-title">
                                  <span>(Web Developer)<span></div>
                                    ...
                                    <div class="dev-btn">
                                      <button type="submit" onclick="location.href='mailto:presidenc@gmail.com';" target="blank">Connect</button>
                                    </div>
                                  </div>
                                  <div class="imgbox">
                                    <img class="profile" src="images\Vivek.png" alt="Vivek Profile">
                              ...
                              <div class="swiper-slide">
                                <div class="dev-card">
                                      ...
                                      <span>(Web Developer)<span></div>
                                        <div class="dev-media">
                                          ...
                                          <a class="social" href="https://www.instagram.com/rohan_0651/">
                                            <svg id="logo" viewbox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                                              <path d="M28.5938 24C28.5938 26.5371 26.5371 28.5938 24 28.5938C21.4629 28.5938 19.4062 26.5371 19.4062 24C19.4062 21.4629 21.4629 19.4062 24 19.4062C26.5371 19.4062 28.5938 21.4629 28.5938 24Z" fill="#013F59"/>
                                              <path
                                                d="M34.7432 15.8723C34.5223 15.2739 34.17 14.7323 33.7123 14.2877C33.2677 13.83 32.7264 13.4777 32.1277 13.2568C31.6421 13.0682 30.9126 12.8438 29.569 12.7826C28.1155 12.7163 27.6797 12.702 24 12.702C20.3199 12.702 19.8842 12.7159 18.431 12.7822C17.0874 12.8438 16.3575 13.0682 15.8723 13.2568C15.2736 13.4777 14.7319 13.83 14.2877 14.2877C13.83 14.7323 13.4777 15.2736 13.2565 15.8723C13.0679 16.3579 12.8434 17.0878 12.7822 18.4314C12.7159 19.8845 12.7017 20.3203 12.7017 24.0004C12.7017 27.6801 12.7159 28.1158 12.7822 29.5693C12.8434 30.913 13.0679 31.6425 13.2565 32.1281C13.4777 32.7268 13.8296 33.2681 14.2874 33.7126C14.7319 34.1704 15.2732 34.5227 15.8719 34.7435C16.3575 34.9325 17.0874 35.157 18.431 35.2181C19.8842 35.2844 20.3196 35.2983 23.9996 35.2983C27.6801 35.2983 28.1158 35.2844 29.5686 35.2181C30.9122 35.157 31.6421 34.9325 32.1277 34.7435C33.3296 34.2799 34.2795 33.33 34.7432 32.1281C34.9318 31.6425 35.1562 30.913 35.2178 29.5693C35.2841 28.1158 35.298 27.6801 35.298 24.0004C35.298 20.3203 35.2841 19.8845 35.2178 18.4314C35.1566 17.0878 34.9321 16.3579 34.7432 15.8723ZM24 31.0767C20.0914 31.0767 16.923 27.9086 16.923 24C16.923 20.0914 20.0914 16.9233 24 16.9233C27.9082 16.9233 31.0767 20.0914 31.0767 24C31.0767 27.9086 27.9082 31.0767 24 31.0767ZM31.3564 18.2974C30.4431 18.2974 29.7026 17.5569 29.7026 16.6436C29.7026 15.7302 30.4431 14.9897 31.3564 14.9897C32.2698 14.9897 33.0103 15.7302 33.0103 16.6436C33.0099 17.5569 32.2698 18.2974 31.3564 18.2974Z"
                                                fill="#013F59"/>
                                              <path
                                  ...
                                  <div class="swiper-slide">
                                    ...
                                    <!-- preloader -->
                                    <div class="preload">
                                      <svg viewbox="0 0 89 106" width="100px" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path id="plogo" stroke="#E7EAEE" stroke-width="4" d="M51 2H2V26C2 26 37.5 24.5 46.5 26C55.5 27.5 56 33 56 37C56 41 52.5504 47.0249 46.5 47H30V66H33.5L53.5 103.5H85L62.5 63.5C78.5976 56.9167 86.5 48.5 84 28.5C81.5 8.5 56 1.99999 51 2Z"/>
                                      </svg>
                                      <div id="boxes">
                                    ...
                                    <nav class="navbar">
                                      <div class="logobox">
                                        <svg class="logo" viewbox="0 0 85 103" xmlns="http://www.w3.org/2000/svg">
                                      ...
                                      <div class="navlinks" id="navlinks">
                                        <a class="one" href="#one">Home</a>
                                        <a class="two" href="#two">Services</a>
                                        <a class="three" href="#abt-us">About</a>
                                        
                                        <a class="five" href="user/login.php">user-login</a>
                                        <a class="six" href="driver/login.php">Driver-login</a>
                                      </div>
                                      <div class="ham-right">
                                    ...
                                    <script>
                                      const scriptURL = 'https://script.google.com/macros/s/AKfycbwvHHMThX2r7bcOKkn-26rG442JNQAfEJQsN-nzJg/exec'
                                    ...
                                    <script>
                                      ...
                                      var firebaseConfig = {
                                        apiKey: "AIzaSyAaGNItiFcE0O3BxO33cOLkp2eSWLwtLJU",
                                        authDomain: "auth-5e4f5.firebaseapp.com",
                                        projectId: "auth-5e4f5",
                                        storageBucket: "auth-5e4f5.appspot.com",
                                        messagingSenderId: "1090701758939",
                                        appId: "1:1090701758939:web:88928f46c79432788b17fe"
                                      };
